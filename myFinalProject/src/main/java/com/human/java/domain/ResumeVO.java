...
public class ResumeVO {
	...
	public void setFile(MultipartFile file) {
		...
		if (!file.isEmpty()) {
			...
			this.user_portfolio_file = file.getOriginalFilename();
...
//			File f = new File("C:\\Users\\human\\Desktop\\sts3\\cWebBoard\\src\\main\\webapp\\resources\\upload\\" + fname_en);
			...
			File p = new File("C:\\Users\\97yeo\\git\\myFinalProject\\myFinalProject\\src\\main\\webapp\\resources\\user_portfolio\\" + user_portfolio_file );
			try {
