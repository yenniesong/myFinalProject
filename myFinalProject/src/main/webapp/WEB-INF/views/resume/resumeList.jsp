      ...
      <!--  JOB LIST - MAIN SEARCH -->
        <div class="row">
          <ul class="job-menu-top">
            ...
            <li>FRONT-END</li>
            <li>FULL STACK</li>
            <li data-bs-toggle="modal" data-bs-target="#staticBackdrop"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row g-2">
                      <!--학력-->
                      <div class="col-md">
                        <p style="font-size: xx-small; color: #878e98;"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="row g-2">
                      ...
                      <div class="col-md">
                        <p style="font-size: xx-small; color: #878e98;"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="row g-2">
                      <!--위치 -->
                      <p style="font-size: xx-small; color: #878e98;"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                      ...
                      <div class="col-md-4">
                        ...
                        <select id="citySelect" class="form-select" size="7" aria-label="size 3 select example"
                          onchange="updateTownSelect()">
                      ...
                      <div class="col-md-8">
                        <select id="townSelect" class="form-select" size="7" aria-label="size 3 select example">
                          <!-- 초기 옵션 = 전체 -->
                          <option value="전체" selected>전체</option>
                        </select>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="search-cancle" data-bs-dismiss="modal"
                      style="background-color: #fff; color: #719a60; border: 1px solid #719a60;">취소</button>
                    <button type="button" class="btn btn-primary" id="search-btn"
                      style="background-color: #719a60; color: #fff; border: 1px solid #719a60;" data-bs-dismiss="modal">검색</button>
							...
							<c:when test="${loginFG == 'c'}">
								...
								<div class="row row-cols-auto">
									...
									<div class="col col-lg-2">
										<a href="recruitAdding.do"><button type="button"
												class="btn btn-success">
												<svg xmlns="http://www.w3.org/2000/svg" width="10"
													height="10" fill="currentColor" class="bi bi-pencil"
													viewBox="0 0 16 16">
                  <path
