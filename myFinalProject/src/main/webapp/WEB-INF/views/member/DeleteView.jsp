...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
     		...
     		<br>
     		<hr>
	<form action="/member/DeleteView2" method="post">
		<table>
			<tr>
			...
			<tr>
				<td colspan="2"><input type="submit" value="회원 탈퇴" onclick="confirmWithdrawal()"></td>
			</tr>
		</table>
	</form>
	<p>${msg}</p>
  ...
  <script src="../resources/js/main.js"></script>
	...
	<script type="text/javascript" defer src="../resources/js/delete.js"></script>
