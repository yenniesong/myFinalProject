...
<body>
  ...
  <table>
    <tr>
      ...
      <td><input type="text" class="name" id="name" name="name" placeholder="이름을 입력해주세요"></td>
    </tr>
    <tr>
      <th><label for="tel">전화번호</label></th>
      <td><input type="tel" class="tel" id="tel" name="tel" placeholder=" - 없이 입력해주세요 "></td>
    </tr>
    <tr>
      <td colspan="2">
        <a href="javascript:void(0)" onclick="fnSubmit();" class="btn">아이디 찾기 >></a>
      </td>
    </tr>
  </table>
  <hr>
