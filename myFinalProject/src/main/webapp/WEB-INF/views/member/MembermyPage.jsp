					...
					<table id="student-fields">
						...
						<tr>
							...
							<td><input type="text" id="nickname" name="nickname"
								required value="${member.nickname}"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><select id="gender" name="gender" required>
									...
									<option value="male" ${member.gender ? 'selected' : ''}>여자</option>
									<option value="female" ${member.gender ? 'selected' : ''}>남자</option>
							</select></td>
						</tr>
						<tr>
							<td><label for="location">거주지</label></td>
							<td><input type="text" id="location" name="location"
								required value="${member.location}"></td>
						</tr>
						<tr>
							<td><label for="position">직업</label></td>
							<td><input type="text" id="position" name="position"
								required value="${member.position}"></td>
						</tr>
						<tr>
							<td><label for="academy">소속 학원</label></td>
							<td><input type="text" id="academy" name="academy" required
								value="${member.academy}"></td>
						</tr>
						<tr>
							<td><label for="employed">취업 여부</label></td>
							<td><select id="employed" name="employed" required>
									<option value="" disabled selected>선택해주세요</option>
									<option value="yes" ${member.employed ? 'selected' : ''}>네</option>
									<option value="no" ${member.employed ? 'selected' : ''}>아니오</option>
							</select></td>
						</tr>
						<tr>
							<td><label for="interests">관심 분야</label></td>
							<td><select id="interests" name="interests" required>
									<option value="" disabled selected>선택해주세요</option>
									<option value="Back"
										${member.interests ? 'selected' : ''}>Back-end</option>
									<option value="Front"
										${member.interests ? 'selected' : ''}>Front-end</option>
									<option value="Full"
										${member.interests ? 'selected' : ''}>Full-stack</option>
							</select></td>
						</tr>
					</table>
					<input type="submit" value="수정" class="updatemember"> 
